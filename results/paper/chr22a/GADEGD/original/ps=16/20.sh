...
python ./code/main.py ./instances/chr22a.dat gadegd t 0 -ps 16 -c PR -aux -seed 20 -csvf /tmp -csvs GADEGD_original_ps=16_20; mv /tmp/objective_value_GADEGD_original_ps=16_20.csv ./results/paper/chr22a/GADEGD/original/ps=16/objective_value_20.csv
