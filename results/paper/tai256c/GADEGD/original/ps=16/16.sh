...
python ./code/main.py ./instances/tai256c.dat gadegd t 0 -ps 16 -c PR -aux -seed 16 -csvf /tmp -csvs GADEGD_original_ps=16_16; mv /tmp/objective_value_GADEGD_original_ps=16_16.csv ./results/paper/tai256c/GADEGD/original/ps=16/objective_value_16.csv
