...
python ./code/main.py ./instances/sko100b.dat gadegd t 0 -ps 128 -c PR -aux -seed 14 -csvf /tmp -csvs GADEGD_original_ps=128_14; mv /tmp/objective_value_GADEGD_original_ps=128_14.csv ./results/paper/sko100b/GADEGD/original/ps=128/objective_value_14.csv
