...
python ./code/main.py ./instances/chr22a.dat gadegd t 0 -ps 64 -c PR -aux -seed 5 -csvf /tmp -csvs GADEGD_original_ps=64_5; mv /tmp/objective_value_GADEGD_original_ps=64_5.csv ./results/paper/chr22a/GADEGD/original/ps=64/objective_value_5.csv
