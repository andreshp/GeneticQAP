...
python ./code/main.py ./instances/sko100c.dat gadegd t 0 -ps 128 -c PR -aux -seed 16 -csvf /tmp -csvs GADEGD_original_ps=128_16; mv /tmp/objective_value_GADEGD_original_ps=128_16.csv ./results/paper/sko100c/GADEGD/original/ps=128/objective_value_16.csv
