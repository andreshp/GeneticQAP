...
python ./code/main.py ./instances/sko100e.dat gadegd t 0 -ps 32 -c PR -aux -seed 18 -csvf /tmp -csvs GADEGD_original_ps=32_18; mv /tmp/objective_value_GADEGD_original_ps=32_18.csv ./results/paper/sko100e/GADEGD/original/ps=32/objective_value_18.csv
