...
python ./code/main.py ./instances/sko100d.dat gadegd t 0 -ps 16 -c PR -aux -seed 2 -csvf /tmp -csvs GADEGD_original_ps=16_2; mv /tmp/objective_value_GADEGD_original_ps=16_2.csv ./results/paper/sko100d/GADEGD/original/ps=16/objective_value_2.csv
