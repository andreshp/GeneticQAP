...
python ./code/main.py ./instances/tai60a.dat gadegd t 0 -ps 16 -c PR -aux -seed 5 -csvf /tmp -csvs GADEGD_original_ps=16_5; mv /tmp/objective_value_GADEGD_original_ps=16_5.csv ./results/paper/tai60a/GADEGD/original/ps=16/objective_value_5.csv
