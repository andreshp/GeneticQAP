...
python ./code/main.py ./instances/sko100e.dat gadegd t 0 -ps 32 -c PR -aux -seed 13 -csvf /tmp -csvs GADEGD_original_ps=32_13; mv /tmp/objective_value_GADEGD_original_ps=32_13.csv ./results/paper/sko100e/GADEGD/original/ps=32/objective_value_13.csv
