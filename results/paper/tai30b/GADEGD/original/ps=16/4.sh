...
python ./code/main.py ./instances/tai30b.dat gadegd t 0 -ps 16 -c PR -aux -seed 4 -csvf /tmp -csvs GADEGD_original_ps=16_4; mv /tmp/objective_value_GADEGD_original_ps=16_4.csv ./results/paper/tai30b/GADEGD/original/ps=16/objective_value_4.csv
