...
python ./code/main.py ./instances/tai60a.dat gadegd t 0 -ps 64 -c PR -aux -seed 7 -csvf /tmp -csvs GADEGD_original_ps=64_7; mv /tmp/objective_value_GADEGD_original_ps=64_7.csv ./results/paper/tai60a/GADEGD/original/ps=64/objective_value_7.csv
