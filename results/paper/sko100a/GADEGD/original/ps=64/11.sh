...
python ./code/main.py ./instances/sko100a.dat gadegd t 0 -ps 64 -c PR -aux -seed 11 -csvf /tmp -csvs GADEGD_original_ps=64_11; mv /tmp/objective_value_GADEGD_original_ps=64_11.csv ./results/paper/sko100a/GADEGD/original/ps=64/objective_value_11.csv
