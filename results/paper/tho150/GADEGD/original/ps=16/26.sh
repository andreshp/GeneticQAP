...
python ./code/main.py ./instances/tho150.dat gadegd t 0 -ps 16 -c PR -aux -seed 26 -csvf /tmp -csvs GADEGD_original_ps=16_26; mv /tmp/objective_value_GADEGD_original_ps=16_26.csv ./results/paper/tho150/GADEGD/original/ps=16/objective_value_26.csv
