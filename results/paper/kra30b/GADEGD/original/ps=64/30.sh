...
python ./code/main.py ./instances/kra30b.dat gadegd t 0 -ps 64 -c PR -aux -seed 30 -csvf /tmp -csvs GADEGD_original_ps=64_30; mv /tmp/objective_value_GADEGD_original_ps=64_30.csv ./results/paper/kra30b/GADEGD/original/ps=64/objective_value_30.csv
