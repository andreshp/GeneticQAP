...
python ./code/main.py ./instances/sko100c.dat gadegd t 0 -ps 16 -c PR -aux -seed 14 -csvf /tmp -csvs GADEGD_original_ps=16_14; mv /tmp/objective_value_GADEGD_original_ps=16_14.csv ./results/paper/sko100c/GADEGD/original/ps=16/objective_value_14.csv
