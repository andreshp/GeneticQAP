...
python ./code/main.py ./instances/esc32b.dat gadegd t 0 -ps 8 -c PR -aux -seed 12 -csvf /tmp -csvs GADEGD_original_ps=8_12; mv /tmp/objective_value_GADEGD_original_ps=8_12.csv ./results/paper/esc32b/GADEGD/original/ps=8/objective_value_12.csv
