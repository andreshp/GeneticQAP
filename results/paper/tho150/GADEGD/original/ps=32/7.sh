...
python ./code/main.py ./instances/tho150.dat gadegd t 0 -ps 32 -c PR -aux -seed 7 -csvf /tmp -csvs GADEGD_original_ps=32_7; mv /tmp/objective_value_GADEGD_original_ps=32_7.csv ./results/paper/tho150/GADEGD/original/ps=32/objective_value_7.csv
