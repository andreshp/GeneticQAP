...
python ./code/main.py ./instances/chr20b.dat gadegd t 0 -ps 32 -c PR -aux -seed 9 -csvf /tmp -csvs GADEGD_original_ps=32_9; mv /tmp/objective_value_GADEGD_original_ps=32_9.csv ./results/paper/chr20b/GADEGD/original/ps=32/objective_value_9.csv
