...
python ./code/main.py ./instances/lipa90b.dat gadegd t 0 -ps 32 -c PR -aux -seed 25 -csvf /tmp -csvs GADEGD_original_ps=32_25; mv /tmp/objective_value_GADEGD_original_ps=32_25.csv ./results/paper/lipa90b/GADEGD/original/ps=32/objective_value_25.csv
