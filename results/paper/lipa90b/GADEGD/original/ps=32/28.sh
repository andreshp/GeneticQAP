...
python ./code/main.py ./instances/lipa90b.dat gadegd t 0 -ps 32 -c PR -aux -seed 28 -csvf /tmp -csvs GADEGD_original_ps=32_28; mv /tmp/objective_value_GADEGD_original_ps=32_28.csv ./results/paper/lipa90b/GADEGD/original/ps=32/objective_value_28.csv
