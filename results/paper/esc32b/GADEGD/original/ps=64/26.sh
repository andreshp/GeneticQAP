...
python ./code/main.py ./instances/esc32b.dat gadegd t 0 -ps 64 -c PR -aux -seed 26 -csvf /tmp -csvs GADEGD_original_ps=64_26; mv /tmp/objective_value_GADEGD_original_ps=64_26.csv ./results/paper/esc32b/GADEGD/original/ps=64/objective_value_26.csv
