...
python ./code/main.py ./instances/sko100d.dat gadegd t 0 -ps 64 -c PR -aux -seed 25 -csvf /tmp -csvs GADEGD_original_ps=64_25; mv /tmp/objective_value_GADEGD_original_ps=64_25.csv ./results/paper/sko100d/GADEGD/original/ps=64/objective_value_25.csv
