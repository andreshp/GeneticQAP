...
python ./code/main.py ./instances/sko100b.dat gadegd t 0 -ps 8 -c PR -aux -seed 29 -csvf /tmp -csvs GADEGD_original_ps=8_29; mv /tmp/objective_value_GADEGD_original_ps=8_29.csv ./results/paper/sko100b/GADEGD/original/ps=8/objective_value_29.csv
