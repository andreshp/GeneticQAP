...
python ./code/main.py ./instances/lipa90b.dat gadegd t 0 -ps 128 -c PR -aux -seed 22 -csvf /tmp -csvs GADEGD_original_ps=128_22; mv /tmp/objective_value_GADEGD_original_ps=128_22.csv ./results/paper/lipa90b/GADEGD/original/ps=128/objective_value_22.csv
