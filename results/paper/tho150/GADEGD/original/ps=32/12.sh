...
python ./code/main.py ./instances/tho150.dat gadegd t 0 -ps 32 -c PR -aux -seed 12 -csvf /tmp -csvs GADEGD_original_ps=32_12; mv /tmp/objective_value_GADEGD_original_ps=32_12.csv ./results/paper/tho150/GADEGD/original/ps=32/objective_value_12.csv
