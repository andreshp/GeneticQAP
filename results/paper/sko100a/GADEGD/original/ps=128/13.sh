...
python ./code/main.py ./instances/sko100a.dat gadegd t 0 -ps 128 -c PR -aux -seed 13 -csvf /tmp -csvs GADEGD_original_ps=128_13; mv /tmp/objective_value_GADEGD_original_ps=128_13.csv ./results/paper/sko100a/GADEGD/original/ps=128/objective_value_13.csv
