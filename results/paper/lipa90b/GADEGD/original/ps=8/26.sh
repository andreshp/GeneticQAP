...
python ./code/main.py ./instances/lipa90b.dat gadegd t 0 -ps 8 -c PR -aux -seed 26 -csvf /tmp -csvs GADEGD_original_ps=8_26; mv /tmp/objective_value_GADEGD_original_ps=8_26.csv ./results/paper/lipa90b/GADEGD/original/ps=8/objective_value_26.csv
