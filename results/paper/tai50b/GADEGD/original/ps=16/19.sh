...
python ./code/main.py ./instances/tai50b.dat gadegd t 0 -ps 16 -c PR -aux -seed 19 -csvf /tmp -csvs GADEGD_original_ps=16_19; mv /tmp/objective_value_GADEGD_original_ps=16_19.csv ./results/paper/tai50b/GADEGD/original/ps=16/objective_value_19.csv
