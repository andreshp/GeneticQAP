...
python ./code/main.py ./instances/tai30b.dat gadegd t 0 -ps 64 -c PR -aux -seed 12 -csvf /tmp -csvs GADEGD_original_ps=64_12; mv /tmp/objective_value_GADEGD_original_ps=64_12.csv ./results/paper/tai30b/GADEGD/original/ps=64/objective_value_12.csv
