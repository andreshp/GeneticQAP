...
python ./code/main.py ./instances/tho150.dat gadegd t 0 -ps 8 -c PR -aux -seed 5 -csvf /tmp -csvs GADEGD_original_ps=8_5; mv /tmp/objective_value_GADEGD_original_ps=8_5.csv ./results/paper/tho150/GADEGD/original/ps=8/objective_value_5.csv
