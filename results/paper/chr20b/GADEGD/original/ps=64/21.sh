...
python ./code/main.py ./instances/chr20b.dat gadegd t 0 -ps 64 -c PR -aux -seed 21 -csvf /tmp -csvs GADEGD_original_ps=64_21; mv /tmp/objective_value_GADEGD_original_ps=64_21.csv ./results/paper/chr20b/GADEGD/original/ps=64/objective_value_21.csv
