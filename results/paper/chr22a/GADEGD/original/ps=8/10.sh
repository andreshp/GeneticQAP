...
python ./code/main.py ./instances/chr22a.dat gadegd t 0 -ps 8 -c PR -aux -seed 10 -csvf /tmp -csvs GADEGD_original_ps=8_10; mv /tmp/objective_value_GADEGD_original_ps=8_10.csv ./results/paper/chr22a/GADEGD/original/ps=8/objective_value_10.csv
