...
python ./code/main.py ./instances/tai256c.dat gadegd t 0 -ps 128 -c PR -aux -seed 5 -csvf /tmp -csvs GADEGD_original_ps=128_5; mv /tmp/objective_value_GADEGD_original_ps=128_5.csv ./results/paper/tai256c/GADEGD/original/ps=128/objective_value_5.csv
