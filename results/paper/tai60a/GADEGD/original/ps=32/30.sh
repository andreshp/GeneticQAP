...
python ./code/main.py ./instances/tai60a.dat gadegd t 0 -ps 32 -c PR -aux -seed 30 -csvf /tmp -csvs GADEGD_original_ps=32_30; mv /tmp/objective_value_GADEGD_original_ps=32_30.csv ./results/paper/tai60a/GADEGD/original/ps=32/objective_value_30.csv
