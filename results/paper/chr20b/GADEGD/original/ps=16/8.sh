...
python ./code/main.py ./instances/chr20b.dat gadegd t 0 -ps 16 -c PR -aux -seed 8 -csvf /tmp -csvs GADEGD_original_ps=16_8; mv /tmp/objective_value_GADEGD_original_ps=16_8.csv ./results/paper/chr20b/GADEGD/original/ps=16/objective_value_8.csv
