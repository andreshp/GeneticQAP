...
python ./code/main.py ./instances/tho150.dat gadegd t 0 -ps 32 -c PR -aux -seed 8 -csvf /tmp -csvs GADEGD_original_ps=32_8; mv /tmp/objective_value_GADEGD_original_ps=32_8.csv ./results/paper/tho150/GADEGD/original/ps=32/objective_value_8.csv
