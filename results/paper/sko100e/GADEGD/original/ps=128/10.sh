...
python ./code/main.py ./instances/sko100e.dat gadegd t 0 -ps 128 -c PR -aux -seed 10 -csvf /tmp -csvs GADEGD_original_ps=128_10; mv /tmp/objective_value_GADEGD_original_ps=128_10.csv ./results/paper/sko100e/GADEGD/original/ps=128/objective_value_10.csv
