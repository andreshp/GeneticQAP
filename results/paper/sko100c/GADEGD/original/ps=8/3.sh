...
python ./code/main.py ./instances/sko100c.dat gadegd t 0 -ps 8 -c PR -aux -seed 3 -csvf /tmp -csvs GADEGD_original_ps=8_3; mv /tmp/objective_value_GADEGD_original_ps=8_3.csv ./results/paper/sko100c/GADEGD/original/ps=8/objective_value_3.csv
