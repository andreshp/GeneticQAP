...
python ./code/main.py ./instances/tai60a.dat gadegd t 0 -ps 128 -c PR -aux -seed 18 -csvf /tmp -csvs GADEGD_original_ps=128_18; mv /tmp/objective_value_GADEGD_original_ps=128_18.csv ./results/paper/tai60a/GADEGD/original/ps=128/objective_value_18.csv
