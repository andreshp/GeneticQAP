...
python ./code/main.py ./instances/tai256c.dat gadegd t 0 -ps 32 -c PR -aux -seed 6 -csvf /tmp -csvs GADEGD_original_ps=32_6; mv /tmp/objective_value_GADEGD_original_ps=32_6.csv ./results/paper/tai256c/GADEGD/original/ps=32/objective_value_6.csv
