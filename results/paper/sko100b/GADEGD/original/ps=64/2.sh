...
python ./code/main.py ./instances/sko100b.dat gadegd t 0 -ps 64 -c PR -aux -seed 2 -csvf /tmp -csvs GADEGD_original_ps=64_2; mv /tmp/objective_value_GADEGD_original_ps=64_2.csv ./results/paper/sko100b/GADEGD/original/ps=64/objective_value_2.csv
