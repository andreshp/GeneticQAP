...
python ./code/main.py ./instances/lipa90b.dat gadegd t 0 -ps 32 -c PR -aux -seed 22 -csvf /tmp -csvs GADEGD_original_ps=32_22; mv /tmp/objective_value_GADEGD_original_ps=32_22.csv ./results/paper/lipa90b/GADEGD/original/ps=32/objective_value_22.csv
