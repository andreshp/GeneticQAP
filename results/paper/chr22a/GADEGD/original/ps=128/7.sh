...
python ./code/main.py ./instances/chr22a.dat gadegd t 0 -ps 128 -c PR -aux -seed 7 -csvf /tmp -csvs GADEGD_original_ps=128_7; mv /tmp/objective_value_GADEGD_original_ps=128_7.csv ./results/paper/chr22a/GADEGD/original/ps=128/objective_value_7.csv
