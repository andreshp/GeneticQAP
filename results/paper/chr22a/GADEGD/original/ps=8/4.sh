...
python ./code/main.py ./instances/chr22a.dat gadegd t 0 -ps 8 -c PR -aux -seed 4 -csvf /tmp -csvs GADEGD_original_ps=8_4; mv /tmp/objective_value_GADEGD_original_ps=8_4.csv ./results/paper/chr22a/GADEGD/original/ps=8/objective_value_4.csv
