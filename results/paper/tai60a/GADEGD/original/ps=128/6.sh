...
python ./code/main.py ./instances/tai60a.dat gadegd t 0 -ps 128 -c PR -aux -seed 6 -csvf /tmp -csvs GADEGD_original_ps=128_6; mv /tmp/objective_value_GADEGD_original_ps=128_6.csv ./results/paper/tai60a/GADEGD/original/ps=128/objective_value_6.csv
