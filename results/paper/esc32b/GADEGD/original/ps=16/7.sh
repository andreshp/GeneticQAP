...
python ./code/main.py ./instances/esc32b.dat gadegd t 0 -ps 16 -c PR -aux -seed 7 -csvf /tmp -csvs GADEGD_original_ps=16_7; mv /tmp/objective_value_GADEGD_original_ps=16_7.csv ./results/paper/esc32b/GADEGD/original/ps=16/objective_value_7.csv
