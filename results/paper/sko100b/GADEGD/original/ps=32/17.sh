...
python ./code/main.py ./instances/sko100b.dat gadegd t 0 -ps 32 -c PR -aux -seed 17 -csvf /tmp -csvs GADEGD_original_ps=32_17; mv /tmp/objective_value_GADEGD_original_ps=32_17.csv ./results/paper/sko100b/GADEGD/original/ps=32/objective_value_17.csv
