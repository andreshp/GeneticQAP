...
python ./code/main.py ./instances/lipa90b.dat gadegd t 0 -ps 16 -c PR -aux -seed 10 -csvf /tmp -csvs GADEGD_original_ps=16_10; mv /tmp/objective_value_GADEGD_original_ps=16_10.csv ./results/paper/lipa90b/GADEGD/original/ps=16/objective_value_10.csv
