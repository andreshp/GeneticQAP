...
python ./code/main.py ./instances/tai256c.dat gadegd t 0 -ps 64 -c PR -aux -seed 17 -csvf /tmp -csvs GADEGD_original_ps=64_17; mv /tmp/objective_value_GADEGD_original_ps=64_17.csv ./results/paper/tai256c/GADEGD/original/ps=64/objective_value_17.csv
