...
python ./code/main.py ./instances/sko100e.dat gadegd t 0 -ps 8 -c PR -aux -seed 11 -csvf /tmp -csvs GADEGD_original_ps=8_11; mv /tmp/objective_value_GADEGD_original_ps=8_11.csv ./results/paper/sko100e/GADEGD/original/ps=8/objective_value_11.csv
