...
python ./code/main.py ./instances/lipa90b.dat gadegd t 0 -ps 64 -c PR -aux -seed 18 -csvf /tmp -csvs GADEGD_original_ps=64_18; mv /tmp/objective_value_GADEGD_original_ps=64_18.csv ./results/paper/lipa90b/GADEGD/original/ps=64/objective_value_18.csv
