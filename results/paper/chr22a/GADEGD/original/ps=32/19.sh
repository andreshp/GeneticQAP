...
python ./code/main.py ./instances/chr22a.dat gadegd t 0 -ps 32 -c PR -aux -seed 19 -csvf /tmp -csvs GADEGD_original_ps=32_19; mv /tmp/objective_value_GADEGD_original_ps=32_19.csv ./results/paper/chr22a/GADEGD/original/ps=32/objective_value_19.csv
